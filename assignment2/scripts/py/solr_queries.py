        ...
        "queries":[
            {
                ...
                "link_based":"http://192.168.1.143:8983/solr/solrCell/select?q=((title%3Asecurity+OR+title%3Aarctic)+OR+(keywords%3Asecurity+OR+keywords%3Aarctic)+OR+(description%3Asecurity+OR+description%3Aarctic)+OR+(text%3Asecurity+AND+text%3Aarctic))+AND+-pagerank:0.0&sort=pagerank+desc&fl=score%2Cpagerank%2Ctitle%2Ckeywords&wt=json&indent=true"
            },
            {
                ...
                "link_based":"http://192.168.1.143:8983/solr/solrCell/select?q=((title%3Asecurity+OR+title%3Aantarctica)+OR+(keywords%3Asecurity+OR+keywords%3Aantarctica)+OR+(description%3Asecurity+OR+description%3Aantarctica)+OR+(text%3Asecurity+AND+text%3Aantarctica))+AND+-pagerank:0.0&sort=pagerank+desc&fl=score%2Cpagerank%2Ctitle%2Ckeywords&wt=json&indent=true"
            },
            {
                ...
                "link_based":"http://192.168.1.143:8983/solr/solrCell/select?q=((title%3Asecurity+OR+title%3A%22southern+ocean%22)+OR+(keywords%3Asecurity+OR+keywords%3A%22southern+ocean%22)+OR+(description%3Asecurity+OR+description%3A%22southern+ocean%22)+OR+(text%3Asecurity+AND+text%3A%22southern+ocean%22))+AND+-pagerank:0.0&sort=pagerank+desc&fl=score%2Cpagerank%2Ctitle%2Ckeywords&wt=json&indent=true"
            }
        ]
